...
return (
  <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
    <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md flex gap-6">
      ...
      <div className={selectedUser ? "flex-1 overflow-x-auto" : "w-full overflow-x-auto"}>
              ...
              {filteredUsers.map((user, idx) => (
                <tr
                  ...
                  className={`border-t dark:border-gray-700 cursor-pointer ${
                    selectedUser?._id === user._id ? "bg-gray-300 dark:bg-gray-700" : ""
                  }`}
                ...
                >
                  ...
                  <td className="px-4 py-2 capitalize">{user.role === 1 ? "Admin" : "User"}</td>
                  ...
                  <td className="px-4 py-2 text-center space-x-3" onClick={(e) => e.stopPropagation()}>
                    <button
  ...
  <div className="flex flex-col gap-4 text-gray-800 dark:text-gray-200 mb-6">
    ...
    <p><strong>Role:</strong> {selectedUser.role === 1 ? "Admin" : "User"}</p>
    <p>
      <strong>Status:</strong>{" "}
      <span className={selectedUser.blocked ? "text-red-500" : "text-green-600"}>
