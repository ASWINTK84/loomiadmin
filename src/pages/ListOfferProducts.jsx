  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
      <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md flex gap-6">
        ...
        <div className={selectedOffer ? "flex-1 overflow-x-auto" : "w-full overflow-x-auto"}>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Offer Products</h2>
            ...
            <table className="min-w-full text-sm bg-white dark:bg-gray-800 rounded-md">
              ...
              <tbody>
                {filteredOffers.map((offer, idx) => {
                  ...
                  const offerPrice = calculateOfferPrice(product?.price || 0, offer.offerPercentage);

                  return (
                    <tr
                      key={offer._id}
                      className={`border-t dark:border-gray-700 cursor-pointer ${
                        selectedOffer?._id === offer._id ? "bg-gray-300 dark:bg-gray-700" : ""
                      }`}
                    ...
                    >
                      ...
                      <td className="px-4 py-2 text-green-600 font-semibold">₹{offerPrice.toFixed(2)}</td>
                      <td
        ...
        {selectedOffer && (
          <div className="w-1/3 bg-gray-50 dark:bg-gray-700 rounded-md p-6 shadow-md flex flex-col items-center text-center">
            ...
            <div className="flex flex-col gap-3 text-gray-800 dark:text-gray-200 mb-6 w-full text-left">
              <p>
                <strong>Category:</strong> {selectedOffer.product?.category?.name}
              </p>
              <p>
                <strong>Description:</strong> {selectedOffer.product?.description || "No description"}
              </p>
              <p>
              ...
              <p className="text-green-600 font-semibold">
                ...
                ₹{calculateOfferPrice(selectedOffer.product?.price, selectedOffer.offerPercentage).toFixed(2)}
              </p>
              <p>
            ...
            <div className="w-full">
              <label htmlFor="offerPercentage" className="block font-medium mb-1 text-left">
                Update Offer Percentage
              </label>
              <input
                id="offerPercentage"
