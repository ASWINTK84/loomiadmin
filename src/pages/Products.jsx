              ...
              {products.map((product) => (
                <tr key={product._id} className="hover:bg-gray-100 dark:hover:bg-gray-700">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <img
                      src={product.imageUrl || `/api/v1/product/product-photo/${product._id}`}
                      alt={product.name}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">
                    {product.sizes && product.sizes.length > 0 ? product.sizes.join(", ").toUpperCase() : "N/A"}
                  </td>
                      ...
                      product.colors.map((color) => (
                        <div key={color} className="flex items-center space-x-1">
                          <span
                            ...
                            title={color}
                          ></span>
                          <span className="text-gray-900 dark:text-white text-xs">{color}</span>
                        </div>
                      ))
                    ) : (
                      "N/A"
