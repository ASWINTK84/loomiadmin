  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
      <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md flex gap-6">
        <div className={selectedContact ? "flex-1 overflow-x-auto" : "w-full overflow-x-auto"}>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Contact Submissions</h2>
          <input
            type="text"
            value={searchTerm}
                ...
                {filteredContacts.map((contact, idx) => (
                  <tr
                    ...
                    className={`border-t dark:border-gray-700 cursor-pointer ${
                      selectedContact?._id === contact._id ? "bg-gray-300 dark:bg-gray-700" : ""
                    }`}
